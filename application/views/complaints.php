...
<div id="content" class="content">
	...
	<ol class="breadcrumb pull-right">
		...
		<li class="breadcrumb-item active"><?php echo $this->lang->line('complaints'); ?></li>
	</ol>
	<!-- end breadcrumb -->
	<!-- begin page-header -->
					...
					<table id="data-table-buttons" class="table table-striped table-bordered">
						...
						<tbody>
							...
							if ($this->session->userdata('user_type') == 3) {
								...
								$complaints = $this->security->xss_clean($this->db->get_where('complaint', array('tenant_id' => $tenant_id))->result_array());
							} else {
								$complaints = $this->security->xss_clean($this->db->get('complaint')->result_array());
							}
