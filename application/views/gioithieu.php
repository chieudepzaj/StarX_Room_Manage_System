...
<body>
        ...
        <div class="nav-bg">
            <div class="main-nav">
                <ul class="mn-left">
                    ...
                    <li class="active"><a href="/starx/gioithieu">Giới thiệu</a> </li>
    ...
    <div class="box-container">
        <div class="content">
            <p>
                <span class="gioithieu-heading">CHÀO MỪNG ĐẾN VỚI KHÁCH SẠN <?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?></span>
            </p>
            <p>
                <span style="font-family: arial, helvetica, sans-serif;">Trải qua hơn 20 năm xây dựng và phát triển, <?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> đang ngày càng khẳng định vị thế và uy tín của mình trong nhiều lĩnh vực khác nhau để trở thành người bạn đồng hành đáng tin cậy của Quý khách hàng.</span>
            </p>
            <p style="text-align: center;"><img src="<?php echo base_url(); ?>uploads/website/starx_gioithieu.jpg" alt="Image no load"></p>
            <p><span class="gioithieu-heading">MY HOUSE - NGÔI NHÀ CỦA TÔI.</span></p>
            <p>
                <span style="font-family: arial, helvetica, sans-serif;">Hệ thống khách sạn StarX có nhiều mức giá linh hoạt và tiết kiệm phù hợp với nhu cầu của Quý khách từ phòng tiêu chuẩn, cao cấp -  căn hộ VIP. "My House – Ngôi nhà của tôi" là khẩu hiệu mang đến một cảm giác thân thuộc, gần gũi như ở nhà.</span>
            </p>
            <p><span style="font-family: arial, helvetica, sans-serif;">Mỗi phòng tại khách sạn StarX được lắp đặt đầy đủ các thiết bị như điều hòa, tivi, tủ lạnh,, máy sấy tóc, quạt sưởi...với hệ thống chăn, ga, gối, đệm được chọn lựa kỹ lưỡng để Quý khách có thể cảm nhận sự thoải mái và tiện nghi nhất.</span></p>
            <p><span style="font-family: arial, helvetica, sans-serif;">Tại khách sạn StarX, Quý khách có thể thoải mái nghỉ ngơi, phóng tầm mắt ra xa ngắm nhìn khung cảnh thành phố tấp nập về đêm hoặc tự do chìm đắm trong không gian của riêng mình giữa chốn Hà Nội náo nhiệt.</span></p>
            <p><span style="font-family: arial, helvetica, sans-serif;">Dịch vụ đạt chuẩn 3 sao từ phòng ốc khách sạn, nhà hàng đa phong cách ẩm thực đến các tiện ích như karaoke, massage. Quý khách chỉ cần lưu trú ở đây là đã được trải nghiệm các tiện ích liền kề với giá ưu đãi </span></p>
            <p><span style="font-family: arial, helvetica, sans-serif;">Điểm công to đùng cho StarX là nó nằm trên tuyến đường huyết mạch trung tâm thủ đô của Quận Hai Bà Trưng. </span></p>
            <p><span style="font-family: arial, helvetica, sans-serif;">Gần hồ Gươm trái tim của Hà Nội, quý khách chỉ mất 5 phút là có thể tới phố đi bộ nhộn nhịp của Hà Nội.</span></p>
            <p><span style="font-family: arial, helvetica, sans-serif;">Phòng ốc với thiết kế gỗ chủ đạo mang lại cảm giác ấm áp, gần gũi cho những ai ghé thăm. Chúng tôi trang bị đầy đủ các tiện ích, đồ dùng nên khách không phải lăn tăn nhé. </span></p>
            <p><span style="font-family: arial, helvetica, sans-serif;">Sẽ bị bất ngờ bởi sự chuyên nghiệp, chu đáo và thân thiện của nhân viên tại đây.</span></p>
