...
<body>
<header>
  <h1>Bạn đã đặt phòng thành công, chúng tôi sẽ sớm liên hệ với bạn, xin cám ơn!</h1>
</header>
...
<p><a href="/starx/datphong">Click here to redirect page now.</a></p>
...
function countdown() {
	...
	if (timeLeft > 0) {
        ...
        location.replace("<?php echo base_url(); ?>datphong");
    }
};
