...
<body>
    ...
    <div class="tieude_giua">
                <?php echo "PHÒNG KHÁCH SẠN 3 SAO SANG TRỌNG HIỆN ĐẠI";?>
    </div>
    <div class="box-container">
        <div class="content">
            <div style="font-family:arial,helvetica,sans-serif; font-size: 14px;">
            <p style="text-align: center;">
                <img style="width:100%; height: auto;"src="<?php echo base_url(); ?>uploads/website/luxury_twin_3.jpg" alt="<?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel">
            </p>
            <br>
            Tại <?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel, mọi sự cố gắng đều nhằm mục đích khiến cho du khách hài lòng. Để làm được điều đó, khách sạn sẽ cung cấp dịch vụ và tiện nghi tốt nhất. Đầu tư mới toàn bộ nội thất, phòng ốc hằng năm, Sự chọn lọc khắt khe những thiết bị hàng đầu như dịch vụ giữ hành lý, quầy lễ tân 24 giờ, báo thức, Miễn phí Wi-fi..... tất cả các phòng để khách có thể tận hưởng thoải mái khi ở khách sạn.
