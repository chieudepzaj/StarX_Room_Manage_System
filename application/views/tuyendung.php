...
<body>
        ...
        <div class="nav-bg">
            <div class="main-nav">
                ...
                <ul class="mn-right">
                    ...
                    <li class="active"><a href="/starx/tuyendung">Tuyển dụng</a></li>
    ...
    <div class="box-container">
        <div class="content">
                ...
                <p>1. Lễ Tân (nam nữ)</p>
                <p>* Yêu cầu:</p>
                <p>- Tiếng Anh hoặc hoa giao tiếp tốt, biết sử dụng phần mềm máy tính.</p>
                <p>- Hình thức ưa nhìn, nhanh nhẹn, khỏe mạnh. trung thực, làm việc Team works tốt.</p>
                <p>- Có kinh nghiệm làm việc Ks là 1 lợi thế.</p>
                
                <p>2. Doorman</p>

                <p>* Yêu cầu:</p>
                <p>- Nhanh nhẹn, khỏe mạnh, sạch sẽ, trung thực.</p>
                <p>- Xác định gắn bó lâu dài là 1 lợi thế.</p>

                <p>❤️ Làm việc trong môi trường Văn minh , lịch sự, thân thiện.</p>
                <p>Liên hệ: 0988776533 để biết thêm chi tiết</p>
                </div>
        </div>
    </div>
