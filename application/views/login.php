			...
			<div class="right-content">
				...
				<div class="login-content">
					...
					<p class="text-center text-grey-darker">
						&copy; 2022 - <?php echo date('Y'); ?> <a href="<?php echo $this->db->get_where('setting', array('setting_id' => 13))->row()->content; ?>" target="_blank"><?php echo $this->db->get_where('setting', array('setting_id' => 13))->row()->content; ?></a>, All rights reserved.
					</p>
				</div>
				<!-- end login-content -->
			</div>
