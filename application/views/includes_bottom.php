...
<script src="<?php echo base_url(); ?>assets/js/toastr-2.1.4.min.js"></script>
<script src="<?php echo base_url(); ?>assets/plugins/gritter/js/jquery.gritter.js"></script>
...
<script src="<?php echo base_url(); ?>assets/js/demo/table-manage-buttons.demo.min.js"></script>
...
<script src="<?php echo base_url(); ?>assets/js/demo/form-wysiwyg.demo.min.js"></script>
<!-- ================== END PAGE LEVEL JS ================== -->
