...
<div class="table-responsive">
	<table class="table">
		<thead>
			<tr>
				<th>#</th>
				<th><b><?php echo $this->lang->line('module'); ?></b></th>
				<th><b><?php echo $this->lang->line('permission'); ?></b></th>
			</tr>
		</thead>
		<tbody>
			<?php
			...
			?>
				<tr>
					...
					<td><?php echo html_escape($this->lang->line(strtolower($module['module_name']))); ?></td>
					<td>
