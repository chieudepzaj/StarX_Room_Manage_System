...
<head>
    ...
    * {
    ...
    .frm_lienhe .item_lienhe {
    margin: 8px 0px;
    clear: both;
    display: flex;
    align-items: center;
    }
    .frm_lienhe .item_lienhe input[type='text'], .frm_lienhe .item_lienhe textarea, .frm_lienhe .item_lienhe input[type='password'], div.frm_lienhe .item_lienhe select {
    width: 65%;
    padding: 8px 10px;
    ...
    .frm_lienhe .item_lienhe p {
    float: left;
    width: 130px;
    }
    .frm_lienhe .item_lienhe input[type='button'], .frm_lienhe .item_lienhe input[type='reset'], .frm_lienhe .item_lienhe input[type='submit'] {
    padding: 10px 25px;
    background: #ee0303;
    border: none;
    color: #fff;
    ...
    .frm_lienhe .item_lienhe input[type='button']+input[type='button'] {
    margin-left: 10px;
    }
    </style>
    ...
    <script>
        function validateForm() {
            let ten_lienhe = document.forms["frm"]["ten_lienhe"].value;
            if (ten_lienhe == "") {
                alert("Xin nhập tên");
                return false;
            }
            let diachi_lienhe = document.forms["frm"]["diachi_lienhe"].value;
            if (diachi_lienhe == "") {
                alert("Xin nhập địa chỉ");
                return false;
            }
            let dienthoai_lienhe = document.forms["frm"]["dienthoai_lienhe"].value;
            if (dienthoai_lienhe == "") {
                alert("Xin nhập số điện thoại");
                return false;
            }
            let email_lienhe = document.forms["frm"]["email_lienhe"].value;
            if (email_lienhe == "") {
                alert("Xin nhập email");
                return false;
            }
            let noidung_lienhe = document.forms["frm"]["noidung_lienhe"].value;
            if (noidung_lienhe == "") {
...
<body>
        ...
        <div class="nav-bg">
            <div class="main-nav">
                ...
                <ul class="mn-right">
                    ...
                    <li class="active"><a href="/starx/lienhe">Liên hệ</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="box-container">
        <div class="content">
            ...
            <form method="post" action="lienhe/add" name="frm" onsubmit="return validateForm()"> 
                <div class="item_lienhe">
                    <p>Họ và Tên: <span style="color:red;">*</span></p>
                    <input name="ten_lienhe" id="ten_lienhe" type="text" class="ten_lienhe" data-parsley-required="true" >
                </div>
                <div class="item_lienhe">
                    <p>Địa chỉ: <span style="color:red;">*</span></p>
                    <input name="diachi_lienhe" id="diachi_lienhe" type="text" class="ten_lienhe" data-parsley-required="true" >
                </div>
                <div class="item_lienhe">
                    <p>Điện thoại: <span style="color:red;">*</span></p>
                    <input name="dienthoai_lienhe" id="dienthoai_lienhe"  type="text" class="ten_lienhe" data-parsley-required="true" >
                </div>
                <div class="item_lienhe">
                    <p>Email: <span style="color:red;">*</span></p>
                    <input name="email_lienhe" id="email_lienhe" type="text" class="ten_lienhe" data-parsley-required="true" >
                </div>
                <div class="item_lienhe">
                    <p>Nội dung: <span style="color:red;">*</span></p>
                    <textarea name="noidung_lienhe" idname="noidung_lienhe" rows="5" class="ten_lienhe" data-parsley-required="true" ></textarea>
                </div>
                <div class="item_lienhe">
                    <p>Mã captcha: <span style="color:red;">*</span></p>
                    <div class="g-recaptcha" data-sitekey="6Le9YDkkAAAAAD9CdB_jO8T2UHRfVx4ZiPjo6JQ1"></div><br/>
                </div>
                <div class="item_lienhe">
                    <p>&nbsp;</p>
