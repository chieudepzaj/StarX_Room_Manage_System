...
<body>
    ...
    <div class="tieude_giua">
                <?php echo "PHÒNG HỘI NGHỊ";?>
    </div>
    <div class="box-container">
        <div class="content">
            <div style="font-family:arial,helvetica,sans-serif; font-size: 18px;">
            <span style="color: #000080; font-weight: 700;"><?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel </span>là địa điểm lý tưởng để các công ty tổ chức hội nghị, hội thảo hay lễ ký kết hợp đồng, chuyên đề tới hội nghị họp mặt, các sự kiện và triển lãm tại Hà Nội.
              
            <p style="text-align: center; margin-top: 10px;">
                <img style="width:100%; height: auto;"src="<?php echo base_url(); ?>uploads/website/hoinghi.jpg" alt="<?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel">
            </p>
            <p style="text-align: center;color:#800000;margin-top:10px;"><strong> Hình 1 : Phòng hội nghị - <?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel</strong></p>
            <p><span style="color: #000080; font-weight: 700;"><?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel </span> có đủ các loại phòng họp - hội nghị và nắm vững các cách bố trí phù hợp nhất, đáp ứng theo số lượng người tham dự, hình thức.</p>
            <p style="color:#008080;">Sân khấu • âm thanh • ánh sáng • máy điều hòa • máy chiếu • màn chiếu • micro không dây • bục phát biểu • hoa trang trí • Flipchart • giấy bút hội nghị • nước uống • Tea break... </p>
            <p style="text-align: center;">
                <img style="width:100%; height: auto;"src="<?php echo base_url(); ?>uploads/website/hoinghi2.jpg" alt="<?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel">
            </p>
            <p style="text-align: center;color:#800000;margin-top:10px;"><strong> Hình 2 : Sảnh hội nghị - <?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel</strong></p>
            <p>Với kinh nghiệm tổ chức với số lượng sự kiện hàng tháng, <span style="color: #000080; font-weight: 700;"><?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel </span> đã thực sự làm hài lòng khách hàng với sự chuyên nghiệp, cẩn trọng, chu đáo. Một hệ thống điều hòa nhiệt độ thân thiện với môi trường vừa được đưa vào sử dụng sẽ giúp cho các phòng hội nghị luôn được cân bằng toàn thời gian. </p>

            <p>Cùng với đầy đủ trang thiết bị hiện đại được đầu tư chất lượng và đội ngũ nhân viên hậu cần, phục vụ chuyên nghiệp sẽ không làm bạn và khách mời thất vọng.</p>
            <p style="text-align: center; margin-top: 10px;">
                <img style="width:100%; height: auto;"src="<?php echo base_url(); ?>uploads/website/hoinghi3.jpg" alt="<?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel">
            </p>
            <p style="text-align: center;color:#800000;margin-top:10px;"><strong> Hình 3 : Phòng hội nghị - <?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel</strong></p>
           
            <p style="text-align: center; margin-top: 10px;">
                <img style="width:100%; height: auto;"src="<?php echo base_url(); ?>uploads/website/hoinghi4.jpg" alt="<?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel">
            </p>
            <p style="text-align: center;color:#800000;margin-top:10px;"><strong> Hình 4 : Phòng hội nghị - <?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel</strong></p>
