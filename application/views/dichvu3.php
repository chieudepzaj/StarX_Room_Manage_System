...
<head>
    ...
    * {
    ...
    <title>PHÒNG THƯ GIÃN SPA- MASSAGE</title>
</head>
...
<body>
    ...
    <div class="tieude_giua">
                <?php echo "PHÒNG THƯ GIÃN SPA- MASSAGE";?>
    </div>
    <div class="box-container">
        <div class="content">
            ...
            Massage <?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel đi đầu trong ngành thư giãn tại Hà Nội trong nhiều năm qua, Chúng tôi luôn chú trọng đảm bảo dịch vụ tốt nhất cho khách hàng. <br>
            + Phòng ốc đầu tư mới hoàn toàn cuối năm 2018. Thiết bị hiện đại, sang trọng, đẳng cấp, không gian yên tĩnh, nhẹ nhàng, thư thái. <br>
            + Ưu tín, thương hiệu: Hoạt động hơn 10 năm trên thị trường, khoảng thời gian tồn tại và phát triển đó đủ chứng minh về chất lượng dịch vụ, độ ưu tín của một Doanh Nghiệp trong điều kiện kinh doanh cực kỳ cạnh tranh như hiện nay. <br>
            + <?php echo $this->db->get_where('setting', array('name' => 'system_name'))->row()->content;?> Hotel chỉ hướng đến chăm sóc sức khỏe và tinh thần sản khoái thật sự cho khách hàng, luôn luôn nói không với các dịch vụ <b style="color:red;">KHÔNG LÀNH MẠNH</b>.<br>
            + Đội ngủ nhân viên chuyên nghiệp, nhiệt tình, vui vẻ. <br>
            <div style="line-height: 2;">
           <b>Đối với làn da:</b>  Massage body thường xuyên có tác dụng kích thích tuyến nội tiết hoạt động ổn định hơn, đồng thời làm giảm lượng chất nhờn tiết ra qua các lỗ chân lông, giúp bạn có một làn da sáng bóng và khỏe mạnh hơn. <br>
        
           <b>Đối với hệ tuần hoàn:</b>  Massage Body có tác dụng đặc biệt với các cơ quan như tim. Bởi khi massage, các động tác vuốt, day ấn sẽ làm giãn nở mạch làm giúp giảm áp lực cho tim và trực tiếp thúc đẩy tuần hoàn máu nhanh hơn. <br style="margin-top:10px">


           <b>Đối với hệ cơ và khớp xương:</b>  Với những động tác day ấn, miết dọc theo bó cơ được lặp đi lặp lại sẽ nhanh chóng làm biến mất sự căng thẳng và đau nhức ở các phần cơ bắp, trả lại cho bạn một cơ thể dẻo dai, tinh thần sung mãn. <br style="margin-top:10px">


           <b>Đối với hệ tiêu hóa:</b>  Có tác dụng tăng cường nhu động của dạ dày, ruột và cải thiện chức năng tiêu hóa. Khi chức năng tiết dịch tiêu hóa (dạ dày, ruột, gan) kém, nên kích thích mạnh để tăng tiết dịch. Khi tiết dịch tiêu hóa vượng, kích thích vừa hoặc nhẹ để giảm tiết dịch. <br style="margin-top:10px">


           <b>Đối với quá trình trao đổi chất:</b>  Massage làm tăng lượng nước tiểu thải ra nhưng không thay đổi pH trong máu. Người ta cho rằng 2, 3 ngày sau khi massage, nitơ trong nước tiểu tăng lên và kéo dài vài ngày, có thể do tác dụng phân giải protid của massage gây nên. <br style="margin-top:10px">

            <br style="margin-top:10px">
            Một ưu điểm rất nổi bật từ massage và đặc biệt là massage body đó chính là cảm giác được tận hưởng những giây phút thư giãn đích thực. Các giác quan của bạn sẽ ngay lập tức được đánh thức với đôi bàn tay ấm nóng của chuyên viên massage, kết hợp với không gian thư thái: có ánh sáng chan hòa ấm cúng, có mùi hương tinh dầu dịu nhẹ cùng tiếng nhạc du dương, sẽ mang đến cho tinh thần của bạn một “bữa tiệc” ngọt ngào và êm ái nhất.
            </div>
            <br>
            ...
            <div class="othernews">
                ...
                <ul class="khac">
                    ...
                    <li><a href="<?php echo base_url(); ?>dichvu/letan" title="QUẦY LỄ TÂN"><i class="far fa-hand-point-right"></i>QUẦY LỄ TÂN</a> (14/2/2023)</li>
