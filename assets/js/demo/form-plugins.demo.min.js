...
var handleDatepicker = function() {
    ...
    handleDateRangePicker = function() {
        ...
        }), $("#advance-daterange span").html(moment().subtract(29, "days").format("MMMM D, YYYY") + " - " + moment().format("MMMM D, YYYY")), $("#advance-daterange").daterangepicker({
            format: "MM/DD/YYYY",
            startDate: moment().subtract(29, "days"),
            endDate: moment(),
            minDate: "01/01/2012",
    ...
    handleSimpleColorpicker = function() {
        $('select[name="jquery-simplecolorpicker"]').simplecolorpicker("selectColor", "#2d353c"), $('select[name="jquery-simplecolorpicker-fa"]').simplecolorpicker({
            theme: "fontawesome"
